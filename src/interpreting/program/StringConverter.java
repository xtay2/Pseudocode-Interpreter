...
/**
 * 
 * Tells, if a {@link String} can be turned into a {@link BuilderExpression} and
 * returns said {@link Expression}.
 */
public abstract class StringConverter {

	/**
	 * Creates a {@link BuilderExpression} from a {@link String}, when only the
	 * expected types are known.
	 * 
	 * @param current       is the {@link String}.
	 * @param expectedTypes are the types that the {@link BuilderExpression} can
	 *                      have.
	 * @param line          is the {@link ProgramLine} that calls this method.
	 * @return a {@link BuilderExpression} or null, if the {@link String} doesn't
	 *         match any type.
	 */
	 ...
	 * 
	 * @param current       is the {@link String}.
	 * @param next          is the follow-up-character after the current
	 *                      {@link String}.
	 * @param expectedTypes are the types that the {@link BuilderExpression} can
	 *                      have.
	 * @param line          is the {@link ProgramLine} that calls this method.
	...
	/**
	 * Returns true if just the current part is a {@link Value} and next is a valid
	 * delimiter.
	 */
	...
	/**
	 * Returns true if just the current part is a {@link Name} and next is a valid
	 * delimiter.
	 */
	...
	/**
	 * Filters through the expected types to find the matching {@link SpecificType}
	 * for the {@link String}.
	 * 
	 ...
	 * @param line          is the {@link ProgramLine} from which this method is
	 *                      called.

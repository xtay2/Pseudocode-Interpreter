...
public enum InfixOpType implements SpecificType {
	...
	// Arithmetic
	ADD("+", 6, LEFT), SUB("-", 6, LEFT), MULT("*", 7, LEFT), DIV("/", 7, LEFT), POW("^", 8, LEFT),
	ROOT("root", 8, LEFT), MOD("%", 7, LEFT),

	// Logic
	AND("and", 3, LEFT), NAND("nand", 3, LEFT), OR("or", 2, LEFT), NOR("nor", 2, LEFT), XOR("xor", 2, LEFT),
	XNOR("xnor", 2, LEFT),
